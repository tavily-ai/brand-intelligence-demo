...
const ICONS: Record<CategoryKey, React.ElementType> = {
  brand_overview: Fingerprint,
  media_press: Newspaper,
  public_perception: Users,
  analyst_competitive: BarChart3,
  risks_opportunities: ShieldAlert,
};
...
export default function ProgressTracker({ categories, brandName }: Props) {
  return (
    <motion.div
    ...
    >
      <div className="flex items-center gap-3 mb-4">
        ...
        <span className="text-sm text-ink-300 font-medium">
          Researching{" "}
          <span className="text-ink-100 font-display italic">{brandName}</span>
        </span>
      </div>
